...
print("differences_list_search:", differences_list_search)
print("differences_dict_search:", differences_dict_search)
print("differences_set_search:", differences_set_search)
print("time_spent_list_search:", time_spent_list_search)
print("time_spent_dict_search:", time_spent_dict_search)
print("time_spent_set_search:", time_spent_set_search)
